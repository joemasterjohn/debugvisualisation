...
/**
 * This criteria punishes a graph layout if the nodes are too close to each
 * other. Every node pair is punished by a value of factor/d, where d is the
...
public class PointDistribution implements Criteria {
	 ...
	 * 
	 * @param factor a linear factor to determine punishment, which is factor/d,
